    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        <div class="z-50 text-left ml-8">
          ...
          <div>{{ song.genre }}</div>
          <div class="song-price">{{ $n(1, 'currency', 'vi') }}</div>
        </div>
      </div>
    </section>
    <!-- Form -->
...
import usePlayerStorage from '@/stores/player'
...
export default {
  ...
  methods: {
    //
    ...mapActions(usePlayerStorage, ['newSong']),
    ...
    // get all comments of the song from collection database
    async getComments() {
      const querySnapshot = await commentsCollection.where('sid', '==', this.$route.params.id).get()
